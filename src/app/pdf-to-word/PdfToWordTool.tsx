        ...
        <>
          {!file ? (
            <FileDropzone
              ...
              subtitle="or browse to select a PDF to convert to Word"
              icon="description"
            />
          ) : (
            <>
              ...
              <div className="flex flex-col items-center gap-3">
                <div
                  className="rounded-xl border border-outline-soft/20 bg-white shadow-md overflow-hidden"
              ...
              {loading && (
                <div className="flex items-center gap-3 bg-primary/5 rounded-xl px-4 py-3.5 text-primary text-sm font-medium">
                  ...
                  Converting via secure cloud engine… this may take a moment.
                </div>
              )}
            </>
          )}
        ...
        <>
          {file ? (
            <div className="space-y-4">
              <div className="bg-surface-low rounded-xl p-4">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-sm font-bold text-on-surface">.docx (Word Document)</span>
                </div>
              </div>
            ...
            <div className="text-center py-4">
              <span className="material-symbols-outlined text-5xl text-outline-soft/50">description</span>
              <p className="text-sm text-on-muted mt-3 leading-relaxed">
                Upload a PDF to convert it into an editable Word document.
              </p>
            </div>
          )}
        </>
      ...
      action={
        <>
          ...
          {downloadUrl && downloadName ? (
            ...
            <button
              onClick={() => file && convert(file, "pdf", "docx")}
